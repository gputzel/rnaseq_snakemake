    ...
    highlight.genes = c(), highlight.color = "red") 
{
    ...
    datapc$Symbol <- suppressMessages(AnnotationDbi::mapIds(org.Hs.eg.db,keys=rownames(datapc),keytype='ENTREZID',column='SYMBOL'))
    datapc$Gene <- suppressMessages(AnnotationDbi::mapIds(org.Hs.eg.db,keys=rownames(datapc),keytype='ENTREZID',column='GENENAME'))
...
- `ggp.rnaseq.human` version: `r packageVersion('ggp.rnaseq.human')`
